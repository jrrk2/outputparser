...
GEN = String_lit.mli String_lit.ml Msat_sat_slit.mli Msat_sat_slit.ml Msat_tseitin.mli Msat_tseitin.ml Rtlil_input_types.ml Rtlil_input.mli Rtlil_input.ml Rtlil_input_tokens.ml Rtlil_input_rewrite_types.ml ord_input.ml Rtlil_input_lex.ml Rtlil_dump.ml Rtlil_input_rewrite.ml generic_rewrite.ml convert_edited.ml Source_generic_main.ml

Source_generic_top: $(GEN)
	ocamlfind ocamlmktop -package msat,hardcaml,hardcaml_circuits -linkpkg -g -o $@ -I +unix unix.cma $(GEN)

Source_text_top: Source_text_types.ml Source_text.mli Source_text.ml Source_text_tokens.ml Source_text_lex.ml Source_text_rewrite_types.ml classify.ml matchmly.ml String_lit.mli String_lit.ml Msat_sat_slit.mli Msat_sat_slit.ml Msat_tseitin.mli Msat_tseitin.ml Source_text_preproc.ml Source_text_rewrite.ml dump_rtlil.ml Rtlil_input_types.ml Rtlil_input.mli Rtlil_input.ml Rtlil_input_tokens.ml Rtlil_input_rewrite_types.ml ord_input.ml Rtlil_input_lex.ml Rtlil_dump.ml Rtlil_input_rewrite.ml Source_text_main.ml convert.ml
	ocamlfind ocamlmktop -package msat -linkpkg -g -o $@ -I +unix unix.cma Source_text_types.ml Source_text.mli Source_text.ml Source_text_tokens.ml Source_text_lex.ml String_lit.{mli,ml} Msat_sat_slit.{mli,ml} Msat_tseitin.{mli,ml} Rtlil_input_rewrite_types.ml Source_text_rewrite_types.ml classify.ml matchmly.ml Source_text_rewrite.ml Source_text_preproc.ml Rtlil_input_types.ml Rtlil_input.mli Rtlil_input.ml Rtlil_input_tokens.ml dump_rtlil.ml Rtlil_input_rewrite_types.ml ord_input.ml Rtlil_input_lex.ml Rtlil_dump.ml Rtlil_input_rewrite.ml convert.ml Source_text_main.ml
...
Source_text_convert: Source_text_types.ml Source_text.ml Source_text_tokens.ml Source_text_lex.ml Msat_sat_slit.mli Msat_sat_slit.ml Source_text_rewrite_types.ml dump_rtlil.ml Rtlil_input.ml Rtlil_input_tokens.ml Rtlil_input_rewrite_types.ml ord_input.ml Rtlil_input_lex.ml classify.ml matchmly.ml Source_text_rewrite.ml Source_text_convert.ml
	ocamlfind ocamlc -package msat -linkpkg -g -o $@ -I +unix unix.cma Source_text_types.ml Source_text.mli Source_text.ml Source_text_tokens.ml Source_text_lex.ml String_lit.{mli,ml} Msat_sat_slit.mli Msat_sat_slit.ml Rtlil_input_rewrite_types.ml Source_text_rewrite_types.ml classify.ml matchmly.ml Msat_tseitin.{mli,ml} Source_text_rewrite.ml Source_text_convert.ml

Source_text_convert_liberty_top: Source_text_types.ml Source_text.ml Source_text_tokens.ml Source_text_lex.ml Msat_sat_slit.mli Msat_sat_slit.ml Source_text_rewrite_types.ml dump_rtlil.ml Rtlil_input.ml Rtlil_input_tokens.ml Rtlil_input_rewrite_types.ml ord_input.ml Rtlil_input_lex.ml classify.ml matchmly.ml Source_text_rewrite.ml Source_text_convert_liberty.ml
	ocamlfind ocamlmktop -package msat -linkpkg -g -o $@ -I +unix unix.cma Source_text_types.ml Source_text.mli Source_text.ml Source_text_tokens.ml Source_text_lex.ml String_lit.{mli,ml} Msat_sat_slit.mli Msat_sat_slit.ml Rtlil_input_rewrite_types.ml Msat_tseitin.{mli,ml} Source_text_rewrite_types.ml classify.ml matchmly.ml Source_text_rewrite.ml Source_text_convert_liberty.ml
...
#	patch Source_text.mly < Source_text.patch
	cp Source_text{_old,}.mly
	cp Source_text_tokens{_old,}.ml
...
Source_text_types.cmo: Source_text_types.ml
	ocamlc.opt -g -c Source_text_types.ml
...
Source_text.ml Source_text.mli: Source_text.mly Source_text_types.cmo
	menhir $(MENHIRFLAGS) $<
...
Input_top: Rtlil_input.cmo Rtlil_input_tokens.cmo Rtlil_input_rewrite_types.ml ord_input.ml Rtlil_input_lex.ml Rtlil_dump.ml Rtlil_input_rewrite.ml Input_main.ml
	ocamlmktop -g -o $@ Rtlil_input_tokens.cmo Rtlil_input_rewrite_types.ml Rtlil_input.cmo ord_input.ml Rtlil_input_lex.ml Rtlil_dump.ml Rtlil_input_rewrite.ml Input_main.ml
...
Rtlil_input.cmo: Rtlil_input_tokens.ml Rtlil_input.ml Rtlil_input.mli
	ocamlc.opt -g -c Rtlil_input.mli Rtlil_input_tokens.ml Rtlil_input.ml

Rtlil_input.cmx: Rtlil_input_tokens.ml Rtlil_input.ml Rtlil_input.mli
	ocamlopt.opt -g -c Rtlil_input.mli Rtlil_input_tokens.ml Rtlil_input.ml

Rtlil_input_lex.ml: Rtlil_input_lex.mll
	ocamllex $<

Rtlil_input.ml Rtlil_input.mli: Rtlil_input.mly
	ocamlc -c Rtlil_input_types.ml
	menhir $(MENHIRFLAGS) $<
