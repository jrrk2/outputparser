...
Source_text_top: Source_text.cmo Source_text_types.cmo Source_text_lex.ml Source_text_rewrite_types.mli dump_vhdl.ml dump_sysver.ml classify.ml matchmly.ml Source_text_rewrite.ml Source_text_main.ml
	ocamlmktop -g -o $@ Source_text_types.cmo Source_text.cmo Source_text_lex.ml Source_text_rewrite_types.mli dump_vhdl.ml dump_sysver.ml classify.ml matchmly.ml Source_text_rewrite.ml

Source_text: Source_text.cmx Source_text_types.cmx Source_text_lex.ml Source_text_rewrite_types.mli dump_vhdl.ml dump_sysver.ml classify.ml matchmly.ml Source_text_rewrite.ml Source_text_main.ml
	ocamlopt.opt -g -o $@ Source_text_types.cmx Source_text.cmx Source_text_lex.ml Source_text_rewrite_types.mli dump_vhdl.ml dump_sysver.ml classify.ml matchmly.ml Source_text_rewrite.ml Source_text_main.ml
