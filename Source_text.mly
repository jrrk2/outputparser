...
dpi_import_export: IMPORT STRING dpi_tf_import_propertyE dpi_importLabelE function_prototype SEMICOLON { TUPLE6(IMPORT,STRING,$3,$4,$5,SEMICOLON) }
	|	IMPORT STRING dpi_tf_import_propertyE dpi_importLabelE task_prototype SEMICOLON { TUPLE6(IMPORT,STRING,$3,$4,$5,SEMICOLON) }
	|	EXPORT STRING dpi_importLabelE FUNCTION idAny SEMICOLON { TUPLE6(EXPORT,STRING,$3,FUNCTION,$5,SEMICOLON) }
	|	EXPORT STRING dpi_importLabelE TASK idAny SEMICOLON { TUPLE6(EXPORT,STRING,$3,TASK,$5,SEMICOLON) }
...
expr: PLUS expr { TUPLE2(PLUS,$2) }
	...
	|	expr yP_LOGIFF expr { TUPLE3($1,$2,$3) }
	|	INTEGER_BLANK_NUMBER { (INTEGER_BLANK_NUMBER) }
	|	FLOATING_HYPHEN_POINT_BLANK_NUMBER { (FLOATING_HYPHEN_POINT_BLANK_NUMBER) }
	|	strAsInt { ($1) }
...
fexpr: PLUS fexpr { TUPLE2(PLUS,$2) }
	...
	|	fexpr yP_LOGIFF fexpr { TUPLE3($1,$2,$3) }
	|	INTEGER_BLANK_NUMBER { (INTEGER_BLANK_NUMBER) }
	|	FLOATING_HYPHEN_POINT_BLANK_NUMBER { (FLOATING_HYPHEN_POINT_BLANK_NUMBER) }
	|	strAsInt { ($1) }
	|	LBRACE constExpr LBRACE cateList RBRACE RBRACE { TUPLE6(LBRACE,$2,LBRACE,$4,RBRACE,RBRACE) }
...
vltItem: vltOffFront { ($1) }
	|	vltOffFront Q_HYPHEN__HYPHEN_FILE STRING { TUPLE3($1,Q_HYPHEN__HYPHEN_FILE,STRING) }
	|	vltOffFront Q_HYPHEN__HYPHEN_FILE STRING Q_HYPHEN__HYPHEN_LINES INTEGER_BLANK_NUMBER { TUPLE5($1,Q_HYPHEN__HYPHEN_FILE,STRING,Q_HYPHEN__HYPHEN_LINES,INTEGER_BLANK_NUMBER) }
	|	vltOffFront Q_HYPHEN__HYPHEN_FILE STRING Q_HYPHEN__HYPHEN_LINES INTEGER_BLANK_NUMBER HYPHEN INTEGER_BLANK_NUMBER { TUPLE7($1,Q_HYPHEN__HYPHEN_FILE,STRING,Q_HYPHEN__HYPHEN_LINES,INTEGER_BLANK_NUMBER,HYPHEN,INTEGER_BLANK_NUMBER) }
	|	vltOnFront { ($1) }
	|	vltOnFront Q_HYPHEN__HYPHEN_FILE STRING { TUPLE3($1,Q_HYPHEN__HYPHEN_FILE,STRING) }
	|	vltOnFront Q_HYPHEN__HYPHEN_FILE STRING Q_HYPHEN__HYPHEN_LINES INTEGER_BLANK_NUMBER { TUPLE5($1,Q_HYPHEN__HYPHEN_FILE,STRING,Q_HYPHEN__HYPHEN_LINES,INTEGER_BLANK_NUMBER) }
	|	vltOnFront Q_HYPHEN__HYPHEN_FILE STRING Q_HYPHEN__HYPHEN_LINES INTEGER_BLANK_NUMBER HYPHEN INTEGER_BLANK_NUMBER { TUPLE7($1,Q_HYPHEN__HYPHEN_FILE,STRING,Q_HYPHEN__HYPHEN_LINES,INTEGER_BLANK_NUMBER,HYPHEN,INTEGER_BLANK_NUMBER) }
