...
| TUPLE6 (STRING "decl_variable_dimension1", LBRACK, hi, COLON, lo, RBRACK) -> `decl_variable_dimension1 (pat hi, pat lo)
...
| TUPLE5 (STRING "conditional_generate_construct1", expr,
   generate_block1, Else, conditional_generate_construct1) -> `conditional_generate_construct1 (pat expr, pat generate_block1, pat conditional_generate_construct1)
...
| TUPLE3 (STRING "system_tf_call1", SystemTFIdentifier id,
        TUPLE4 (STRING "call_base1", LPAREN, TLIST lst, RPAREN)) -> (`system_tf_call1 (id, patlst lst))
...
| TUPLE4 (STRING "non_anonymous_gate_instance_or_register_variable1",
  SymbolIdentifier id, EMPTY_TOKEN, asgn) -> `non_anonymous_gate_instance_or_register_variable1 (id, pat asgn)
| TUPLE3 (STRING "trailing_decl_assignment2", EQUALS, rhs) -> `trailing_decl_assignment2
| TUPLE4 (STRING "non_anonymous_gate_instance_or_register_variable1",
      SymbolIdentifier id, dim,
    EMPTY_TOKEN) -> `non_anonymous_gate_instance_or_register_variable1 (id, pat dim)
...
| TUPLE6 (STRING "select_variable_dimension3", LBRACK, unqualified_id2, PLUS_COLON, unqualified_id3, RBRACK) -> `select_variable_dimension3 (pat unqualified_id2, pat unqualified_id3)
...
| TUPLE3 (STRING "any_port_list_trailing_comma1", TLIST lst, COMMA) -> `any_port_list_trailing_comma1 (patlst lst)
| TUPLE3 (STRING "any_port_list_item_last1", trailing, named) -> `any_port_list_item_last1 (pat trailing, pat named)
| TUPLE6 (STRING "port_named1", DOT, SymbolIdentifier id, LPAREN, unqualified_id1, RPAREN) ->  `port_named1 (id, pat unqualified_id1)
| TUPLE5 (STRING "port_named2", DOT, SymbolIdentifier id, LPAREN, RPAREN) -> `port_named2 id
| TUPLE3 (STRING "port_named3", DOT, SymbolIdentifier id) -> `port_named3 id
| TUPLE3 (STRING "label_opt1", COLON, SymbolIdentifier id) -> `label_opt1 id
...
| TUPLE3 (STRING "reference2", unqualified_id1, ext) -> `reference2 (pat unqualified_id1, pat ext)
| TUPLE3 (STRING "hierarchy_extension1", DOT, unqualified_id2) -> `hierarchy_extension1 (pat unqualified_id2)
| TUPLE3 (STRING "reference3", unqualified_id1, dim) -> `reference3 (pat unqualified_id1, pat dim)
| TUPLE12 (STRING "module_or_interface_declaration1", Module, EMPTY_TOKEN,
      SymbolIdentifier id, EMPTY_TOKEN,
      TUPLE5 (STRING "module_parameter_port_list_opt1", HASH, LPAREN, TLIST lst, RPAREN),
      TUPLE4 (STRING "module_port_list_opt1", LPAREN, TLIST lst', RPAREN),
...
| TUPLE4 (STRING "add_expr2", expr1, PLUS, expr2) -> `add_expr (pat expr1, pat expr2)
